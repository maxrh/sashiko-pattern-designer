      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Select Tool (V):</span>
              ...
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Pen Tool (P):</span>
                <span className="text-muted-foreground">Click on grid points to draw stitches between them.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Pan Tool (Space):</span>
                <span className="text-muted-foreground">Hold spacebar to pan around the canvas.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Stitch Color:</span>
                <span className="text-muted-foreground">Choose a color for new stitches or change the color of selected stitches.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Stitch Length:</span>
                <span className="text-muted-foreground">Adjust the length of individual stitches in the running stitch pattern (Small/Medium/Large).</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Stitch Gap:</span>
                <span className="text-muted-foreground">Adjust the spacing between individual stitches in the running stitch pattern.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Stitch Width:</span>
                <span className="text-muted-foreground">Adjust the visual thickness of the stitch lines (Thin/Medium/Bold).</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Repeat Pattern (R):</span>
              ...
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Undo/Redo:</span>
                <span className="text-muted-foreground">Undo (Ctrl+Z) or redo (Ctrl+Y) your last actions.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Show Grid (H):</span>
          ...
          <section>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Artboard Size:</span>
              ...
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">New Pattern:</span>
                <span className="text-muted-foreground">Create a new blank pattern. Unsaved changes will be lost.</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="font-medium min-w-28">Save Pattern:</span>
          ...
          <section>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">V</kbd>
                <span className="text-muted-foreground">Switch to Select Tool</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">P</kbd>
                <span className="text-muted-foreground">Switch to Pen Tool</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">R</kbd>
                <span className="text-muted-foreground">Toggle Repeat Pattern</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">H</kbd>
                <span className="text-muted-foreground">Toggle Show/Hide Grid</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">Ctrl + Z</kbd>
                <span className="text-muted-foreground">Undo last action</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">Ctrl + Y</kbd>
                <span className="text-muted-foreground">Redo last undone action</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">Ctrl + S</kbd>
                <span className="text-muted-foreground">Save current pattern</span>
              </div>
              <div className="flex items-start gap-3">
                <kbd className="min-w-28 rounded border border-border bg-muted px-2 py-1 font-mono text-xs">Backspace</kbd>
